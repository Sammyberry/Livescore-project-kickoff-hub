...
function Profile() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white flex flex-col items-center px-4 py-6">
      ...
      {/* Profile content */}
      <main className="w-full max-w-6xl rounded-2xl shadow-2xl flex flex-col md:flex-row items-center md:items-start justify-between p-30 gap-10">
        {/* Left section */}
        <div className="flex flex-col items-center w-full md:w-1/3 text-center">
          {/* Avatar */}
          <div className="w-32 h-32 md:w-36 md:h-36 bg-gray-600 rounded-full mb-5"></div>

          <h2 className="text-xl md:text-2xl font-semibold mb-4">Username</h2>
        ...
        <div className="w-full md:w-2/3 text-center md:text-left">
          <h1 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-200 text-center md:text-left">
